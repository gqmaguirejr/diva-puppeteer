...
(async() => {
    ...
    await setTextAreaLang(page, textareaHandles, areaNames, 'Presentation ', 'eng');
    ...
    //selector='[id="addForm:authorSerie:0:autEmail"]';
    ...
    selector='[id="addForm:authorSerie:0:j_id736"]';
    ...
    kthid='u1ft3a12';
    //selector='[id="addForm:supervisorSerie:0:j_id1200"]';
    selector=make_selector_from_id(blanks['Supervisor1']['Local User Id'].ID);
    await page.$eval(selector, (el, value) => el.value = value, kthid);

    orcid='0000-0002-4226-9652'
    //selector='[id="addForm:supervisorSerie:0:j_id1205"]'
    ...
    //selector='[id="addForm:supervisorSerie:0:supEmail"]';
    ...
    //await page.$eval('[id="addForm:authorSerie:0:j_id736"]', (el, value) => el.value = value, org_COS);
    // Note that I cannot look for EECS in the test DiVA as it has only the old organization info
    //selector='[id="addForm:supervisorSerie:0:j_id1214';
    ...
    // Note that I cannot look for EECS in the test DiVA as it has only the old organization info
    await page.waitFor(1000);
    //selector='[id="addForm:examinerSerie:0:j_id1293"]';
