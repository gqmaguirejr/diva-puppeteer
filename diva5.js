...
const nationalSubjectCategory =  require('./National_subject_categories.json');
degree_info={
    "Level": {
	// Level field:
...
async function makeOrganizationSelection(page, blanks, textAreaName) {
	...
	tmp1=thesis_info[textAreaName]['organisation']['L1'];
	tmp=kth_org[tmp1]['ID'];
	...
	if (thesis_info[textAreaName]['organisation'].hasOwnProperty('L2')) {
	    tmp2=thesis_info[textAreaName]['organisation']['L2'];
	    tmp=kth_org[tmp1][tmp2]['ID'];
		...
		// organisationPopupForm:tree:n-9-1
	...
	selector=make_prefix_selector_from_id('organisationPopupForm:tree:n-root'+tmp)+' a';
